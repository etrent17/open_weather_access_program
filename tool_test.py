...
def test_from_k_fahrenheit():
    assert from_kelvin_fahrenheit(temp_list[0]) == -9.67
    assert from_kelvin_fahrenheit(temp_list[1]) == 26.33
    assert from_kelvin_fahrenheit(temp_list[2]) == 80.33
    assert from_kelvin_fahrenheit(temp_list[3]) == 134.33
    
def test_from_kelvin_celsius():
    assert from_kelvin_celsius(temp_list[0]) == -23.15
    assert from_kelvin_celsius(temp_list[1]) == -3.15
    assert from_kelvin_celsius(temp_list[2]) == 26.85
    assert from_kelvin_celsius(temp_list[3]) == 56.85
